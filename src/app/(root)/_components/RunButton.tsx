...
function RunButton() {
  ...
  return (
    ...
    >
      {/* bg wit gradient */}
      <div className="absolute inset-0 bg-gradient-to-r bg-green-400 rounded-xl opacity-100 transition-opacity group-hover:opacity-90" />
